    ...
    <>
      <section className="workSection" id="realisations" aria-labelledby="work-title">
        ...
        <div className="workGrid">
          <article className="workCard workCardWide">
            <div className="workVisual cleanyVisual">
              <div className="workVisualChrome"><span>01</span><span>B2B / FRAMER / SEO</span></div>
              <div className="workMock workMockLarge"><span>VRAIE CAPTURE CLEANY À INTÉGRER</span></div>
            </div>
          ...
          <article className="workCard">
            <div className="workVisual acierVisual">
              ...
              <div className="workMock"><span>VRAIE CAPTURE ACIER SHOP À INTÉGRER</span></div>
            </div>
          ...
          <article className="workCard">
            <div className="workVisual mpVisual">
              ...
              <div className="workMock"><span>VRAIE CAPTURE M. PARISIENNE À INTÉGRER</span></div>
            </div>
      ...
      <section className="featuredCaseSection" aria-labelledby="featured-case-title">
        <div className="featuredCaseShell">
          ...
          <div className="featuredCaseVisual">
            <div className="caseDevice caseDeviceDesktop">
              ...
              <div className="caseMediaPlaceholder">
                <strong>VRAIE CAPTURE CLEANY</strong>
                <span>Desktop homepage / page offre</span>
              </div>
            </div>
      ...
      <section className="partnerSection" aria-label="Système d’apport d’affaires">
        ...
        <div className="partnerAction">
          ...
          <a href="#partenaires">Découvrir notre système d’apport d’affaires <span>→</span></a>
        </div>
      </section>
